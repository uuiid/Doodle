...
struct bind_value_t {
  ...
  std::function<std::string(const bind_value_t&, storage& in_storage, to_sql_ctx ctx)> to_string_fun_;
  ...
  std::string to_string(storage& in_storage, to_sql_ctx ctx) const;
};
