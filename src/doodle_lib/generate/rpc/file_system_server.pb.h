...
class DOODLELIB_API file_info_server PROTOBUF_FINAL :
 ...
 public:
  ...
  inline file_info_server* New() const final {
    return CreateMaybeMessage<file_info_server>(nullptr);
  }
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_file_5fsystem_5fserver_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class DOODLELIB_API file_stream_server PROTOBUF_FINAL :
 ...
 public:
  ...
  inline file_stream_server* New() const final {
    return CreateMaybeMessage<file_stream_server>(nullptr);
  }
  ...
  ::doodle::file_info_server* release_info();
...
class DOODLELIB_API file_info_move_server PROTOBUF_FINAL :
 ...
 public:
  ...
  inline file_info_move_server* New() const final {
    return CreateMaybeMessage<file_info_move_server>(nullptr);
  }
  ...
  ::doodle::file_info_server* release_source();
  ...
  ::doodle::file_info_server* release_target();
...
inline void file_info_server::set_path(const std::string& value) {
...
inline void file_info_server::set_path(std::string&& value) {
  
  path_.Set(
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:doodle.file_info_server.path)
}
inline void file_info_server::set_path(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  
  path_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, ::std::string(value), GetArena());
  // @@protoc_insertion_point(field_set_char:doodle.file_info_server.path)
}
inline void file_info_server::set_path(const char* value,
    size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:doodle.file_info_server.path)
}
...
inline ::doodle::file_info_server* file_stream_server::_internal_mutable_info() {
  ...
  if (info_ == nullptr) {
    auto* p = CreateMaybeMessage<::doodle::file_info_server>(GetArena());
    info_ = p;
  }
  return info_;
}
