...
DOODLE_HTTP_FUN(actions_projects_tasks_comment_many, post, ucom_t{} / "api" / "actions" / "projects" / &capture_id_t::id_ / "tasks" / "comment-many", http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
...
DOODLE_HTTP_FUN(data_project, get, ucom_t{} / "api" / "data" / "projects" / &capture_id_t::id_, http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
...
DOODLE_HTTP_FUN(data_tasks_full, get, ucom_t{} / "api" / "data" / "tasks" / &capture_id_t::id_ / "full", http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
// api/data/comments/{comment_id}
DOODLE_HTTP_FUN(data_comment, get, ucom_t{} / "api" / "data" / "comments" / &capture_id_t::id_, http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
...
DOODLE_HTTP_FUN(movies_low_preview_files, get, ucom_t{} / "api" / "movies" / "low" / "preview-files" / make_cap(fmt::format("{}.mp4", g_uuid_regex), &capture_id_t::id_), http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
// /api/movies/originals/preview-files/{id}.mp4
DOODLE_HTTP_FUN(movies_originals_preview_files, get, ucom_t{} / "api" / "movies" / "originals" / "preview-files" / make_cap(fmt::format("{}.mp4", g_uuid_regex), &capture_id_t::id_), http_jwt_fun_template<capture_id_t>)
boost::asio::awaitable<boost::beast::http::message_generator> callback_arg(
    session_data_ptr in_handle, std::shared_ptr<capture_id_t> in_arg
) override;
DOODLE_HTTP_FUN_END()
