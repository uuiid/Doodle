...
DOODLE_HTTP_FUN(actions_user_notifications_mark_all_as_read)
DOODLE_HTTP_FUN_OVERRIDE(post)
DOODLE_HTTP_FUN_END()
// /api//actions/projects/{project_id}/tasks/comment-many
DOODLE_HTTP_FUN(actions_projects_tasks_comment_many)
DOODLE_HTTP_FUN_OVERRIDE(post)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/data/tasks/{task_id}/comments/{comment_id}/ack
DOODLE_HTTP_FUN(data_tasks_comments_ack)
DOODLE_HTTP_FUN_OVERRIDE(post);
uuid task_id_{};
uuid comment_id_{};
DOODLE_HTTP_FUN_END()
// /api/data/projects/{project_id}/team
DOODLE_HTTP_FUN(data_projects_team)
DOODLE_HTTP_FUN_OVERRIDE(post)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/actions/tasks/{task_id}/comments/{comment_id}/preview-files/{preview_file_id}
DOODLE_HTTP_FUN(actions_tasks_comments_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(post)
uuid task_id_{};
uuid comment_id_{};
...
DOODLE_HTTP_FUN(pictures_thumbnails_organisations)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/pictures/thumbnails-square/preview-files/{id}
DOODLE_HTTP_FUN(pictures_thumbnails_square_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/pictures/thumbnails/preview-files/{id}
DOODLE_HTTP_FUN(pictures_thumbnails_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/pictures/thumbnails/persons/{id}
DOODLE_HTTP_FUN(pictures_thumbnails_persons)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/pictures/originals/preview-files/{id}/download
DOODLE_HTTP_FUN(pictures_originals_preview_files_download)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/pictures/originals/preview-files/{id}
DOODLE_HTTP_FUN(pictures_originals_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()

// /api/pictures/previews/preview-files/{id}
DOODLE_HTTP_FUN(pictures_previews_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
...
DOODLE_HTTP_FUN(data_tasks_open_tasks)
DOODLE_HTTP_FUN_OVERRIDE(get)
DOODLE_HTTP_FUN_END()
// /api/data/assets/<asset_id>/cast-in
DOODLE_HTTP_FUN(data_assets_cast_in)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/data/entities/<entity_id>/news
DOODLE_HTTP_FUN(data_entities_news)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
...
DOODLE_HTTP_FUN_END()
// /api/auth/logout
DOODLE_HTTP_FUN(auth_logout)
DOODLE_HTTP_FUN_OVERRIDE(get)
DOODLE_HTTP_FUN_END()
// /api/movies/low/preview-files/{id}.mp4
DOODLE_HTTP_FUN(movies_low_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/movies/originals/preview-files/{id}.mp4
DOODLE_HTTP_FUN(movies_originals_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/movies/tiles/preview-files/{id}.png
DOODLE_HTTP_FUN(movies_tiles_preview_files)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid id_{};
DOODLE_HTTP_FUN_END()

// /api/data/tasks/{task_id}/comments/{comment_id}
DOODLE_HTTP_FUN(task_comment)
...
DOODLE_HTTP_FUN_END()
// /api/data/tasks/{id}
DOODLE_HTTP_FUN(data_task)
DOODLE_HTTP_FUN_OVERRIDE(delete_)
uuid id_{};
DOODLE_HTTP_FUN_END()
// /api/data/projects/{project_id}/team/{person_id}
DOODLE_HTTP_FUN(data_project_team_person)
DOODLE_HTTP_FUN_OVERRIDE(delete_)
uuid project_id_;
uuid person_id_;
DOODLE_HTTP_FUN_END()
