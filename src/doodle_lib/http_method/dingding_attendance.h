...
DOODLE_HTTP_FUN(dingding_attendance_get)
DOODLE_HTTP_FUN_OVERRIDE(get)
uuid user_id_;
chrono::year_month year_month_{};
DOODLE_HTTP_FUN_END()
//"/api/doodle/attendance/{user_id}"
DOODLE_HTTP_FUN(dingding_attendance_create_post)
DOODLE_HTTP_FUN_OVERRIDE(post)
uuid id_{};
DOODLE_HTTP_FUN_END()
// "/api/doodle/attendance/{user_id}/custom"
DOODLE_HTTP_FUN(dingding_attendance_id_custom)
DOODLE_HTTP_FUN_OVERRIDE(post)
uuid id_{};
DOODLE_HTTP_FUN_END()
// "/api/doodle/attendance/custom/{id}"
DOODLE_HTTP_FUN(dingding_attendance_custom)
