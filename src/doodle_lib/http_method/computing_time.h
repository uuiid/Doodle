...
DOODLE_HTTP_FUN(computing_time, patch, "/api/doodle/computing_time/{user_id}/{year_month}", http_jwt_fun)
boost::asio::awaitable<boost::beast::http::message_generator> callback(session_data_ptr in_handle) override;
DOODLE_HTTP_FUN_END()

DOODLE_HTTP_FUN(computing_time, delete_, "/api/doodle/computing_time/{user_id}/{year_month}", http_jwt_fun)
boost::asio::awaitable<boost::beast::http::message_generator> callback(session_data_ptr in_handle) override;
DOODLE_HTTP_FUN_END()
