...
FSys::path get_shots_auto_lighting_upload_animation_name(const episodes& episode_, const shot& shot_,  const std::string& project_code_);
FSys::path get_shots_auto_lighting_upload_simulation_name(const episodes& episode_, const shot& shot_,  const std::string& project_code_);
