...
/// 角色模型ue 路径
inline FSys::path get_entity_character_ue_path(
    const FSys::path& asset_root_path_, std::int32_t gui_dang_, std::int32_t kai_shi_ji_shu_,
...
/// 角色模型 ue 名称
inline std::string get_entity_character_ue_name(const std::string& bian_hao_, const std::string& pin_yin_ming_cheng_) {
  return fmt::format(
...
/// 道具模型 ue 名称
inline std::string get_entity_prop_ue_name(
...
/// 场景模型 ue map 名称
inline std::string get_entity_ground_ue_map_name(
    const std::string& bian_hao_, const std::string& pin_yin_ming_cheng_, const std::string& ban_ben_
) {
  return fmt::format(
...
///  场景模型 ue sk 名称
inline std::string get_entity_ground_ue_sk_name(
    const std::string& bian_hao_, const std::string& pin_yin_ming_cheng_, const std::string& ban_ben_
) {
  return fmt::format(
...
/// 场景名称 alembic 名称
inline std::string get_entity_ground_alembic_name(
    const std::string& bian_hao_, const std::string& pin_yin_ming_cheng_, const std::string& ban_ben_
) {
...
/// 角色模型图片 路径
inline FSys::path get_entity_character_image_path(
    const FSys::path& asset_root_path_, std::int32_t gui_dang_, std::int32_t kai_shi_ji_shu_,
    const std::string& bian_hao_
) {
...
/// 动画文件名称
inline std::string get_shots_animation_file_name(
    const std::string& episode_name_, const std::string& shot_name_, const std::string& project_code_
) {
  return fmt::format("{}_{}_{}", project_code_, episode_name_, shot_name_);
}
inline FSys::path conv_ue_game_path(const FSys::path& in_path) {
