...
class linear_layer {
 ...
 public:
  ...
  MatrixXfRow forward(const MatrixXfRow& input) const;
  ...
  MatrixXfRow forward_batched(const MatrixXfRow& input, std::int64_t batch_size, std::int64_t time_steps) const;
  ...
  [[nodiscard]] const MatrixXfRow& weight() const { return weight_; }
