  ...
  auto make_storage_doodle(const std::string& in_path) {
    ...
    return std::move(make_storage(
        ...
        make_table(
            ...
            foreign_key(&task_type_asset_type_link::asset_type_id_)
                .references(&asset_type::uuid_id_)
                .on_delete.cascade(),
        ...
        make_table(
            ...
            foreign_key(&project_task_status_link::task_status_id_)
                .references(&task_status::uuid_id_)
                .on_delete.cascade()
        ),
        make_table(
        ...
        make_table(
            ...
            foreign_key(&project_status_automation_link::project_id_)
