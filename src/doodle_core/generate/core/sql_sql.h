...
namespace doodle_database
{
  ...
  namespace Season_
  {
    ...
    struct PInt
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "p_int";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T pInt;
            T& operator()() { return pInt; }
            const T& operator()() const { return pInt; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::can_be_null>;
    };
  ...
  struct Season: sqlpp::table_t<Season,
               Season_::Id,
               Season_::EntityId,
               Season_::PInt>
  {
  ...
  namespace Importance_
  {
    ...
    struct CutoffP
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "cutoff_p";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T cutoffP;
            T& operator()() { return cutoffP; }
            const T& operator()() const { return cutoffP; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
  ...
  struct Importance: sqlpp::table_t<Importance,
               Importance_::Id,
               Importance_::EntityId,
               Importance_::CutoffP>
  {
    struct _alias_t
    {
  ...
  namespace Project_
  {
    ...
    struct PName
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "p_name";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
    ...
    struct PPath
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "p_path";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T pPath;
            T& operator()() { return pPath; }
            const T& operator()() const { return pPath; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
    struct PEnStr
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "p_en_str";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T pEnStr;
            T& operator()() { return pEnStr; }
            const T& operator()() const { return pEnStr; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
    struct PShorStr
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "p_shor_str";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T pShorStr;
            T& operator()() { return pShorStr; }
            const T& operator()() const { return pShorStr; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::text, sqlpp::tag::can_be_null>;
    };
