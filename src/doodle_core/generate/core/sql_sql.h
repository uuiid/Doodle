// generated by E:/Doodle/build/Ninja_debug/vcpkg_installed/x64-windows/scripts/sqlpp11-ddl2cpp
// E:/Doodle/src/doodle_core/core/sql_file.sql E:/Doodle/src/doodle_core/generate/core/sql_sql doodle_database
...
namespace doodle_database
{
  ...
  struct Episodes : sqlpp::table_t<Episodes, Episodes_::Id, Episodes_::EntityId, Episodes_::Eps> {
    struct _alias_t {
  ...
  struct Shot : sqlpp::table_t<Shot, Shot_::Id, Shot_::EntityId, Shot_::ShotInt, Shot_::ShotAb> {
    struct _alias_t {
