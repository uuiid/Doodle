...
#include <doodle_core/database_task/details/main_map.h>
...
using obs_all = obs_main<
    ...
    std::tuple<
        ...
        doodle::user, doodle::project, doodle::project_config::base_config, main_project, ue_main_map, maya_anim_file,
        scene_id, character_id, prop_id, rig_id, animation_id, simulation_id>>;
}  // namespace doodle::database_n