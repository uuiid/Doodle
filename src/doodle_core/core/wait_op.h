...
struct wait_op_lasting {
 public:
  using func_type = void (*)(wait_op_lasting *op);
 ...
 protected:
  ...
  wait_op_lasting(func_type func, std::shared_ptr<void> in_shared_ptr)
      : func_(func), handler_(std::move(in_shared_ptr)) {}
  ~wait_op_lasting() = default;
};
}  // namespace doodle::detail
