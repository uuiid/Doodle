...
void to_json(nlohmann::json& nlohmann_json_j, const rpc_json_progress& nlohmann_json_t) {
  nlohmann_json_j["msg"]      = nlohmann_json_t.msg_;
  nlohmann_json_j["progress"] = nlohmann_json_t.progress_;
...
void from_json(const nlohmann::json& nlohmann_json_j, rpc_json_progress& nlohmann_json_t) {
  nlohmann_json_j.at("msg").get_to(nlohmann_json_t.msg_);
  nlohmann_json_j.at("progress").get_to(nlohmann_json_t.progress_);
