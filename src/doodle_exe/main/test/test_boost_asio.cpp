...
class fork_executor {
 public:
  using fork_join_pool = boost::asio::io_context;
  typedef fork_join_pool inner_executor_type;
  ...
  fork_join_pool& query(boost::asio::execution::context_t) const noexcept {
    return context_;
  }
