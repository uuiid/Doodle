...
void tool_box_menu_factory::create_menu() {
  ...
  p_action.push_back(k_export_maya);
  ...
  p_action.push_back(k_create_video);
  ...
  p_action.push_back(k_import_ue4);
