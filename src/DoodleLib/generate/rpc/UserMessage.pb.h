...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_UserMessage_2eproto_metadata_getter(int index);
namespace doodle {
class user_database;
...
class user_database PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_UserMessage_2eproto_metadata_getter(kIndexInFileMessages);
  }
