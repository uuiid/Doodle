...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_FileSystemServer_2eproto_metadata_getter(int index);
namespace doodle {
class FileInfo;
...
class FileInfo PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_FileSystemServer_2eproto_metadata_getter(kIndexInFileMessages);
  }
...
class FileStream PROTOBUF_FINAL :
 ...
 public:
  ...
  virtual ~FileStream();
  explicit constexpr FileStream(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class FileInfoMove PROTOBUF_FINAL :
 ...
 public:
  ...
  explicit constexpr FileInfoMove(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
