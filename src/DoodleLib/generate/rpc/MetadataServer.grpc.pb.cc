...
::grpc::Status MetadataServer::Stub::InstallMetadata(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::doodle::DataDb* response) {
  return ::grpc::internal::BlockingUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_InstallMetadata_, context, request, response);
}

void MetadataServer::Stub::experimental_async::InstallMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_InstallMetadata_, context, request, response, std::move(f));
}

void MetadataServer::Stub::experimental_async::InstallMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::PrepareAsyncInstallMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_InstallMetadata_, context, request);
}

::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::AsyncInstallMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status MetadataServer::Stub::DeleteMetadata(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::doodle::DataDb* response) {
  return ::grpc::internal::BlockingUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_DeleteMetadata_, context, request, response);
}

void MetadataServer::Stub::experimental_async::DeleteMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_DeleteMetadata_, context, request, response, std::move(f));
}

void MetadataServer::Stub::experimental_async::DeleteMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::PrepareAsyncDeleteMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_DeleteMetadata_, context, request);
}

::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::AsyncDeleteMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::Status MetadataServer::Stub::UpdateMetadata(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::doodle::DataDb* response) {
  return ::grpc::internal::BlockingUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_UpdateMetadata_, context, request, response);
}

void MetadataServer::Stub::experimental_async::UpdateMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_UpdateMetadata_, context, request, response, std::move(f));
}

void MetadataServer::Stub::experimental_async::UpdateMetadata(::grpc::ClientContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::PrepareAsyncUpdateMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_UpdateMetadata_, context, request);
}

::grpc::ClientAsyncResponseReader< ::doodle::DataDb>* MetadataServer::Stub::AsyncUpdateMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
::grpc::ClientReader< ::doodle::DataDb>* MetadataServer::Stub::FilterMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb_Filter& request) {
  return ::grpc::internal::ClientReaderFactory< ::doodle::DataDb>::Create(channel_.get(), rpcmethod_FilterMetadata_, context, request);
}

void MetadataServer::Stub::experimental_async::FilterMetadata(::grpc::ClientContext* context, const ::doodle::DataDb_Filter* request, ::grpc::experimental::ClientReadReactor< ::doodle::DataDb>* reactor) {
  ::grpc::internal::ClientCallbackReaderFactory< ::doodle::DataDb>::Create(stub_->channel_.get(), stub_->rpcmethod_FilterMetadata_, context, request, reactor);
}

::grpc::ClientAsyncReader< ::doodle::DataDb>* MetadataServer::Stub::AsyncFilterMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb_Filter& request, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::doodle::DataDb>::Create(channel_.get(), cq, rpcmethod_FilterMetadata_, context, request, true, tag);
}

::grpc::ClientAsyncReader< ::doodle::DataDb>* MetadataServer::Stub::PrepareAsyncFilterMetadataRaw(::grpc::ClientContext* context, const ::doodle::DataDb_Filter& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderFactory< ::doodle::DataDb>::Create(channel_.get(), cq, rpcmethod_FilterMetadata_, context, request, false, nullptr);
}
...
MetadataServer::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< MetadataServer::Service, ::doodle::DataDb, ::doodle::DataDb, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](MetadataServer::Service* service,
             ::grpc::ServerContext* ctx,
             const ::doodle::DataDb* req,
             ::doodle::DataDb* resp) {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::ServerStreamingHandler< MetadataServer::Service, ::doodle::DataDb_Filter, ::doodle::DataDb>(
          [](MetadataServer::Service* service,
             ::grpc::ServerContext* ctx,
             const ::doodle::DataDb_Filter* req,
             ::grpc::ServerWriter<::doodle::DataDb>* writer) {
...
::grpc::Status MetadataServer::Service::InstallMetadata(::grpc::ServerContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response) {
  (void) context;
  (void) request;
  (void) response;
...
::grpc::Status MetadataServer::Service::DeleteMetadata(::grpc::ServerContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status MetadataServer::Service::UpdateMetadata(::grpc::ServerContext* context, const ::doodle::DataDb* request, ::doodle::DataDb* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
...
::grpc::Status MetadataServer::Service::FilterMetadata(::grpc::ServerContext* context, const ::doodle::DataDb_Filter* request, ::grpc::ServerWriter< ::doodle::DataDb>* writer) {
  (void) context;
  (void) request;
  (void) writer;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
