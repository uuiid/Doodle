...
class DOODLELIB_API rpc_metadata_client {
 ...
 public:
  ...
  [[nodiscard]] std::vector<ProjectPtr> get_project();
  /**
   ...
   */
  [[nodiscard]] std::vector<MetadataPtr> get_child(const MetadataConstPtr& in_metadataPtr);
   ...
   */
  void install_metadata(const MetadataPtr& in_metadataPtr);
  void delete_metadata(const MetadataConstPtr& in_metadataPtr);
  void update_metadata(const MetadataConstPtr& in_metadataPtr, bool b_update_parent_id);
  [[nodiscard]] std::vector<MetadataPtr> filter_metadata(const rpc_filter::rpc_filter_ptr& in_filter_ptr);
};
}  // namespace doodle
