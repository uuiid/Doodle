...
- 最上层的id分别是 
  ...
  - 993093656 镜头
- 引用的uuid 为另一个文件的uuid
- 引用除了使用uuid作为标识以外还可以使用uuid_path键作为标识， 这两者可以相互替换， uuid_path键使用文件
对于项目根目录作为引用使用
````json
{
  "3465700403": {
...
```json
{
  "v1": {
    "1409699020": {
      "data": {
        "ShowName": "",
        "department": -842150451,
        "name": "",
        "path": "test/path/to/export_abc_or_fbx.fbx",
        "user": "",
        "version": 14829735431805717965
      }
    },
    "291512165": {
      "data": {
    ...
    "3465700403": {
      "data": {
        "ref_meta": [
          {
            "uuid": {
              "uuid": "f9d77fe8-b491-4daf-ab03-800aa38a8134"
            }
          }
        ]
      }
