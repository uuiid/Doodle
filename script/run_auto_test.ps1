...
{
#    Write-Host $uuid
    Start-Process -FilePath "E:\Doodle\build\Ninja_debug\bin\doodle_auto_light_client.exe" -WorkingDirectory "E:\Doodle\build\Ninja_debug\bin" -ArgumentList "--address=127.0.0.1:50025", "--uuid=$uuid"
}
