...
void FPluginMenuModule::StartupModule()
{
	...
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_1UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_1UITab))
		.SetDisplayName(FText::FromString("Load Skeleton Anim"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);
	
	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_2UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_2UITab))
		.SetDisplayName(FText::FromString("Load BP Anim"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);

	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_3UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_3UITab))
		.SetDisplayName(FText::FromString("Create Map"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);

	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_4UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_4UITab))
		.SetDisplayName(FText::FromString("Create Map With Custom BP"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);


	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_5UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_5UITab))
		.SetDisplayName(FText::FromString("Create Map With Refrenced BP"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);

	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_6UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_6UITab))
		.SetDisplayName(FText::FromString(" Clean up Map"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);

	FGlobalTabmanager::Get()->RegisterNomadTabSpawner(Menu1_7UITabName, FOnSpawnTab::CreateRaw(this, &FPluginMenuModule::OnSpawnMenu1_7UITab))
		.SetDisplayName(FText::FromString(" Clean up Folder"))
		.SetMenuType(ETabSpawnerMenuType::Hidden);
...
void FPluginMenuModule::OpenMenuTab(FName TabName)
{
	if (MenuTabManager.IsValid())
	{
		...
		{
			MenuTabManager->InvokeTab(TabName);
		}
		else
		{
			...
			{
				TSharedRef<SDockTab> PluginTab = FGlobalTabmanager::Get()->InvokeTab(TabName);
