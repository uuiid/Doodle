...
//---------------------------
DoodleEffectEditorViewportClient::DoodleEffectEditorViewportClient(FAssetEditorModeManager* InAssetEditorModeManager, FPreviewScene* InPreviewScene,
	...
	: FEditorViewportClient{InAssetEditorModeManager, InPreviewScene, InEditorViewportWidget}
{
	...
	SetInitialViewTransform(LVT_Perspective, EditorViewportDefs::DefaultPerspectiveViewLocation, EditorViewportDefs::DefaultPerspectiveViewRotation,
...
TSharedRef<class SEditorViewport> DoodleEffectEditorViewport::GetViewportWidget()
{
