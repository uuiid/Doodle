...
/**
 * Declares a delegate that is executed when a file was picked in the SFilePathsPicker widget.
 *
 * The first parameter will contain the path to the picked file.
 */
DECLARE_DELEGATE_OneParam(FOnPathsPicked, const TArray<FString>& /*PickedPath*/);


/**
 * Implements an editable text box with a browse button.
 */
class SFilePathsPicker
	: public SCompoundWidget
{
public:

	SLATE_BEGIN_ARGS(SFilePathsPicker)
		: _BrowseButtonToolTip(NSLOCTEXT("SFilePathsPicker", "BrowseButtonToolTip", "Choose a file from this computer"))
	...
	{ }
		...
		SLATE_EVENT(FOnPathsPicked, OnPathPicked)
