...
public:
  ...
  // 经度曲线  竖线
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "Doodle_Light", DisplayName = "longitudeCurve")
  FRuntimeFloatCurve p_longitude;

  // 纬度曲线  横线
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "Doodle_Light", DisplayName = "latitudeCurve", meta = (UIMin = "0"))
  FRuntimeFloatCurve p_latitude;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "Doodle_Light", DisplayName = "light max", meta = (UIMin = "0"))
  float p_light_max;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "Doodle_Light", DisplayName = "light min", meta = (UIMin = "0"))
  float p_light_min;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Category = "Doodle_Light", DisplayName = "night", meta = (UIMin = "0"))
  float p_night;
