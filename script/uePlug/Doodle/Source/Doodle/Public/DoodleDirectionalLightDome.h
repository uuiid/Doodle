...
class DOODLE_API ADoodleDirectionalLightDome : public AActor {
 ...
 public:
  ...
  // 经度曲线  竖线
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "longitudeCurve")
  FRuntimeFloatCurve p_longitude;

  // 纬度曲线  横线
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "latitudeCurve", meta = (UIMin = "0"))
  FRuntimeFloatCurve p_latitude;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "light max", meta = (UIMin = "0"))
  float p_light_max;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "light min", meta = (UIMin = "0"))
  float p_light_min;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "night", meta = (UIMin = "0"))
  float p_night;

  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "specular min", meta = (UIMin = "0"))
  ...
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "阴影量", meta = (UIMin = "0", UIMax = "1"))
  float p_shadowAmout;

  // 镜像强度映射
  UPROPERTY(EditAnyWhere, BlueprintReadOnly, Interp, Category = "Doodle_Light",
            DisplayName = "light to specular", meta = (UIMin = "0"))
  ...
  UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Doodle_Light",
            DisplayName = "lightArray")
