...
#include "BatchRenderQueueEngineSubsystem.generated.h"

DECLARE_DELEGATE(FOnBatchRenderQueueExecutorFinishedNative);
DECLARE_DELEGATE_OneParam(FOnBatchRenderQueueExecutorFinishedNative2,TArray<UMoviePipelineExecutorJob*>);
...
*/
UCLASS(BlueprintType, meta = (DisplayName = "BatchRender Runtime Subsystem"))
class BATCHRENDER_API UBatchRenderQueueEngineSubsystem : public UEngineSubsystem
{
	GENERATED_BODY()

public:

	UBatchRenderQueueEngineSubsystem()
	{
	...
	*/
	...
	FOnBatchRenderQueueExecutorFinishedNative OnBatchRenderFinished;

	FOnBatchRenderQueueExecutorFinishedNative2 OnBatchRenderFinished2;
