...
@REM robocopy %my_pwd%\build\Ninja_release %my_pwd%\build\html\file *.exe /ndl /np /njh /njs /ns /nc /nfl /m
@REM robocopy %my_pwd%\build\Ninja_release %my_pwd%\build\html\file *.7z /ndl /np /njh /njs /ns /nc /nfl /m
...
@REM python %my_pwd%/docs/generate_updata_log.py %my_pwd%/build/html/update.html
