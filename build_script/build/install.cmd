...
robocopy %my_pwd%\build\Ninja_release %my_pwd%\build\html\file *.exe /ndl /np /njh /njs /ns /nc /nfl
robocopy %my_pwd%\build\Ninja_release %my_pwd%\build\html\file *.7z /ndl /np /njh /njs /ns /nc /nfl
